...
class BrickBreaker:
        ...
        if self.highscore.add_score(self.score):
            ...
            self.screen.blit(
                ...
                (
                    ...
                    (self.screen_height - new_high_score_text_height) / 2 + 
                    text_height + score_text_height
                )
            )
    ...
    def reset_game(self, player_level: int = 1, score: int = 0):
        """
    ...
    def show_level_won(self):
        ...
        self.reset_game(self.player_level + 1, self.score)
